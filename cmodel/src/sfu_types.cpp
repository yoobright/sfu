...
// Approximate sigmoid(-|x|) over |x| / 16 in [0, 1).  C0 uses Q0.26;
// C1/C2 retain enough headroom for derivatives with respect to |x| / 16.
const FunctionParams Function::SIGMOID = {7, 1, -1, 1, -1, 2, 3};
