...
module RangeReduce(	// scala/SFU.scala:275:7
  ...
  wire [30:0]      tanhArg = io_in_bits_op == 4'h7 ? sigShifted >> 1 : sigShifted;
  wire             tanhFine = tanhArg < 31'h800000;
  wire             tanhMiddle = tanhArg < 31'h2000000;
  wire [30:0]      tanhMiddleDelta = tanhArg - 31'h800000;
  wire [30:0]      tanhCoarseDelta = tanhArg - 31'h2000000;
  wire [6:0]       tanhIndex = tanhFine
    ? {1'h0, tanhArg[22:17]}
    : tanhMiddle ? 7'h40 + tanhMiddleDelta[24:19]
                 : 7'h70 + tanhCoarseDelta[25:21];
  wire [15:0]      tanhLocal = tanhFine
    ? tanhArg[16:1]
    : tanhMiddle ? tanhMiddleDelta[18:3] : tanhCoarseDelta[20:5];
...
module LookupTable(	// scala/SFU.scala:357:7
  ...
  always @(posedge clock) begin	// scala/SFU.scala:357:7
    if (reset)	// scala/SFU.scala:357:7
      ...
      s1Pipe_rValid <= _s1Pipe_T | ~(io_out_ready & s1Pipe_rValid) & s1Pipe_rValid;	// scala/SFU.scala:109:29, :114:36, :116:18, :117:31, :118:18, src/main/scala/chisel3/util/Decoupled.scala:51:35
    if (_s1Pipe_T) begin	// src/main/scala/chisel3/util/Decoupled.scala:51:35
      s1Pipe_rBits_c0 <= io_in_bits_op == 4'h9
        ? tanhC0[io_in_bits_index] : _GEN_26[io_in_bits_op[2:0]];
      s1Pipe_rBits_c1 <= io_in_bits_op == 4'h9
        ? tanhC1[io_in_bits_index] : _GEN_27[io_in_bits_op[2:0]];
      s1Pipe_rBits_c2 <= io_in_bits_op == 4'h9
        ? tanhC2[io_in_bits_index] : _GEN_28[io_in_bits_op[2:0]];
...
module Poly(	// scala/SFU.scala:435:7
  ...
  wire [33:0] _aligned0_T =
    ...
    >> (io_in_bits_op == 3'h6 | io_in_bits_op == 3'h5 | io_in_bits_op == 3'h4
        | io_in_bits_op == 3'h3
          ? 5'h13
          : io_in_bits_op == 3'h7 | io_in_bits_op == 4'h9 | io_in_bits_op == 3'h2
              ? 5'h11
  ...
  wire        _sigmoidOp = s2Pipe_rBits_op == 3'h7 | s2Pipe_rBits_op == 4'h9;
  wire [28:0] aligned2 =
...
module Compose(	// scala/SFU.scala:527:7
  ...
  wire             s1_ready = ~s1Pipe_rValid | io_out_ready;	// scala/SFU.scala:109:29, :111:{35,43}
  wire [26:0]      halfTanh = io_in_bits_polyResult >> 1;
  wire [26:0]      sigmoidFixed =
    io_in_bits_sign ? 27'h2000000 - halfTanh : 27'h2000000 + halfTanh;
  wire             tanhFamily = io_in_bits_op == 4'h7 | io_in_bits_op == 4'h9;
  wire [26:0]      activationFixed =
    io_in_bits_op == 4'h7 ? sigmoidFixed : io_in_bits_polyResult;
  wire [33:0]      sum =
    tanhFamily
      ? {7'h0, activationFixed}
      : {io_in_bits_exp, io_in_bits_polyResult[25:0]};
  wire [33:0]      sumAbs =
    tanhFamily ? sum : io_in_bits_exp[7] ? ~sum + 34'h1 : sum;
  wire [7:0]       _GEN =
    ...
    if (_s1Pipe_T)	// src/main/scala/chisel3/util/Decoupled.scala:51:35
      s1Pipe_rBits_result <=
        io_in_bits_bypass
          ...
          : io_in_bits_op == 4'h9
              ? {io_in_bits_sign, _expSin_T, _mantSin_T[32:10]}
              : io_in_bits_op == 4'h8
              ? {1'h0, _expSqrt_T, io_in_bits_polyResult[24:2]}
